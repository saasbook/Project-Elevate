class Booking < ApplicationRecord
    def self.check_time_slot(start_slot, end_slot, id, month, day)
      date_start_slot = DateTime.new(DateTime.now.year.to_i, month.to_i, day.to_i, start_slot.hour, start_slot.min)
      date_end_slot = DateTime.new(DateTime.now.year.to_i, month.to_i, day.to_i, end_slot.hour, end_slot.min)
