class Booking < ApplicationRecord
    def self.check_time_slot(start_slot, end_slot, id, month_day)
      date_start_slot = DateTime.new(DateTime.now.year.to_i, month_day[0].to_i, month_day[1].to_i, start_slot.hour, start_slot.min, 0, "-07:00")
      date_end_slot = DateTime.new(DateTime.now.year.to_i, month_day[0].to_i, month_day[1].to_i, end_slot.hour, end_slot.min, 0, "-07:00")
