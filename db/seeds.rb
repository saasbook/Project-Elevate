...
calendars = [{:name => "Train with the Roger Destroyer", :UserId => 1, :OtherId => 2,  :typeEvent => "Coaching", :start_time => "2020-04-05 10:00:00", :end_time => "2020-04-05 12:00:00"},
            ...
            {:name => "Club Event", :UserId => nil, :OtherId => nil,  :typeEvent => "Event", :details => "First Tournament!", :start_time => "2019-04-11 10:00:00", :end_time => "2019-04-11 12:00:00"},
            {:name => "Club Event", :UserId => nil, :OtherId => nil,  :typeEvent => "Event", :details => "Second Tournament!", :start_time => "2019-04-05 10:00:00", :end_time => "2019-04-05 12:00:00"},
            {:name => "Club Event", :UserId => nil, :OtherId => nil,  :typeEvent => "Event", :details => "Third Tournament!", :start_time => "2020-04-13 10:00:00", :end_time => "2020-04-13 12:00:00"},
            {:name => "Club Event", :UserId => nil, :OtherId => nil,  :typeEvent => "Event", :details => "Fourth Tournament!", :start_time => "2020-05-17 10:00:00", :end_time => "2020-05-17 12:00:00"},
            ...
            {:name => "Play with Joe Chen", :UserId => 5, :OtherId => 1,  :typeEvent => "Play", :start_time => "2020-04-23 10:00:00", :end_time => "2020-04-23 12:00:00"},
            {:name => "Play with Jason Yang", :UserId => 1, :OtherId => 5,  :typeEvent => "Play", :start_time => "2020-04-23 10:00:00", :end_time => "2020-04-23 12:00:00"},
            {:name => "Coach Jason Yang", :UserId =>2, :OtherId => 5, :typeEvent => "Coaching", :start_time => "2020-04-14 10:00:00", :end_time => "2020-04-14 12:00:00"}, 
            {:name => "Train with Roger Destroyer", :UserId =>5, :OtherId => 2, :typeEvent => "Coaching", :start_time => "2020-04-14 10:00:00", :end_time => "2020-04-14 12:00:00"}]
